    ...
    try:
        ...
        products = [
            ('Диван «Комфорт»',
             ...
             45000, 'Диваны', 8),
            ('Диван «Премиум Люкс»',
             'Угловой диван из натуральной кожи. Встроенный бар и USB-зарядка. Размер: 310×175×90 см.', 78000, 'Диваны', 3),
            ('Диван угловой «Модерн»',
             'Стильный угловой диван в скандинавском стиле. Съёмные чехлы. Размер: 280×170×88 см.', 62000, 'Диваны', 5),
            ('Кровать «Сон»', 'Двуспальная кровать 160×200 с подъёмным механизмом и бельевым ящиком.', 35000, 'Кровати', 12),
            ('Кровать «Классика»', 'Кровать из массива дуба 180×200. Резное изголовье ручной работы.', 52000, 'Кровати', 4),
            ('Кровать «Лофт»', 'Кровать на металлическом каркасе в стиле лофт. 160×200.', 28000, 'Кровати', 7),
            ('Шкаф-купе «Гардероб»', 'Трёхдверный шкаф-купе с зеркалом. Ширина 240 см, глубина 60 см.', 54000, 'Шкафы', 6),
            ('Шкаф «Мини»', 'Компактный двухдверный шкаф. Ширина 120 см. Идеален для небольших комнат.', 22000, 'Шкафы', 0),
            ('Стол обеденный «Дуб»', 'Раскладной стол из массива дуба. Размер: 160-200×90 см.', 38000, 'Столы', 9),
            ('Стол письменный «Офис»', 'Эргономичный рабочий стол 140×70. Встроенный кабель-менеджмент.', 18000, 'Столы', 15),
            ('Стул «Элегант»', 'Обеденный стул с мягким сиденьем. Каркас — массив бука.', 8500, 'Стулья', 20),
            ('Кресло «Релакс»', 'Мягкое кресло с механизмом качания. Обивка: велюр. Цвет: серый.', 22000, 'Стулья', 10),
            ('Барный стул «Хай»', 'Барный стул с регулировкой высоты 60-80 см. Хромированная ножка.', 7500, 'Стулья', 1),
            ('Кухня «Стандарт»', 'Кухонный гарнитур 2.4 м. Фасады МДФ, столешница 38 мм. Цвет: белый.', 95000, 'Кухни', 3),
            ('Кухня «Премиум»', 'Угловая кухня 3.2 м. Фасады — эмаль, фурнитура Blum. Цвет: графит.', 145000, 'Кухни', 2),
        ]
        ...
        conn.commit()
        conn.close()
        logger.info("✅ БД заполнена начальными данными (3 сотрудника, 6 категорий, 15 товаров)")
    except sqlite3.Error as e:
